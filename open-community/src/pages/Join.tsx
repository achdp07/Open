          ...
          <div className="bg-teal-dark p-12 flex flex-col justify-between">
            ...
            <div className="flex flex-col gap-6">
              <h2 className="text-3xl font-black text-white leading-tight">
                Rejoins la <span className="text-lime-bright">génération</span> numérique
              </h2>
              <p className="text-slate-400 text-sm leading-relaxed">
                Une communauté qui forme les jeunes aux compétences numériques,
                à l'innovation et aux technologies de demain.
              </p>
              <div className="flex gap-8">
                {[['500+', 'Membres'], ['30+', 'Ateliers'], ['20+', 'Partenaires']].map(([val, label]) => (
                  <div key={label}>
            ...
            <p className="text-slate-600 text-xs">© 2026 Open Community</p>
          </div>
